...
class Create {
    ...
    drawText() {
        // daftar warna merah makin gelap
        ...
        let tutorial = [
            ...
            "←: Tambah kolom kiri",
            "→: Tambah kolom kanan",
            "Enter: Simpan dan coba main",
            "Klik: Ubah nilai (0→9)",
            "P: Pasang/lepas balok biasa",
            "Q: Pasang/lepas balok panjat",
            "S: Tambah titik mulai",
            "K: Ubah titik akhir",
            "B: Pasang/lepas saklar biasa",
            "M: Pasang/lepas saklar tahan",
            "H: Simpan file dengan data",
        ];
    ...
    drawSolid() {
        ...
        if (this.isB > 0) {
            ...
            if (this.isB == 2) {
                this.context.fillText("Pilih posisi yang dipengaruhi", this.gameWidth * 0.75 + this.gameWidth * 0.25 / 2, this.gameHeight - 25);
            } else {
                this.context.fillText(this.vct, this.gameWidth * 0.75 + this.gameWidth * 0.25 / 2, this.gameHeight - this.sizeBlock / 1.5);
                this.context.fillText("Tekan Z untuk pilih tinggi", this.gameWidth * 0.75 + this.gameWidth * 0.25 / 2, this.gameHeight - 25);
            }
        }
